...
import { Mail, Check, Users, Phone, GraduationCap, MessageSquare, Headphones as HeadphonesIcon , Menu, X} from 'lucide-react';
      ...
      <header className="fixed top-0 left-0 right-0 bg-om-forest-deep/95 backdrop-blur-md border-b border-om-forest z-50">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-om-forest-deep border-t border-om-forest px-6 py-4 flex flex-col gap-4">
            <button onClick={nav('navigate-to-features')} className="text-left text-base text-om-tan hover:text-om-parchment transition-colors py-1">Features</button>
            <button onClick={nav('navigate-to-pricing')}  className="text-left text-base text-om-tan hover:text-om-parchment transition-colors py-1">Pricing</button>
            <button onClick={nav('navigate-to-about')}    className="text-left text-base text-om-tan hover:text-om-parchment transition-colors py-1">About</button>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="bg-om-cream border border-om-tan rounded-xl p-8 hover:shadow-lg transition-shadow">
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl md:text-3xl font-display font-semibold text-om-forest-deep">Individual</h3>
                </div>
                <p className="text-om-mahogany mb-6 text-base md:text-lg" style={{ fontFamily: "'EB Garamond', serif" }}>
              ...
              <div className="border-t border-om-tan pt-7">
                <h4 className="font-display font-semibold text-om-forest-deep mb-5 text-sm md:text-base tracking-wide uppercase">What's Included</h4>
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={title} className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-medium text-om-forest-deep text-base md:text-lg">{title}</div>
            ...
            <div className="bg-om-forest-deep rounded-xl p-8 text-om-parchment relative overflow-hidden hover:shadow-2xl transition-shadow">
              <div className="absolute top-4 right-4 bg-om-gold/20 border border-om-gold/40 px-3 py-1 rounded text-xs md:text-sm font-medium text-om-gold tracking-wide">
                Most Popular
              </div>
              ...
              <div className="mb-8">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-2xl md:text-3xl font-display font-semibold">Teams</h3>
                </div>
                <p className="text-om-tan mb-6 text-base md:text-lg" style={{ fontFamily: "'EB Garamond', serif" }}>
                ...
                <div className="mb-6 p-4 bg-om-forest border border-om-forest-dark rounded-lg">
                  <p className="text-sm md:text-base text-om-tan uppercase tracking-widest mb-3">Custom Pricing</p>
                  <div className="text-2xl md:text-4xl font-display font-semibold text-om-gold mb-1">Contact Sales</div>
                  <div className="text-base md:text-lg text-om-tan">Tailored to your team's needs</div>
                </div>
                <button
              ...
              <div className="border-t border-om-forest pt-7">
                <h4 className="font-display font-semibold text-om-gold mb-5 text-sm md:text-base tracking-wide uppercase">Everything in Individual, plus:</h4>
                <ul className="space-y-4">
                  {[
                    ...
                    <li key={title} className="flex items-start gap-3">
                      ...
                      <div>
                        <div className="font-medium text-om-parchment text-base md:text-lg">{title}</div>
                        <div className="text-base md:text-lg text-om-tan">{sub}</div>
                      </div>
                    </li>
                  ))}
                </ul>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={q} className="bg-om-cream border border-om-tan rounded-lg p-6">
                <h3 className="font-display font-semibold text-om-forest-deep mb-2 text-base md:text-lg">{q}</h3>
                <p className="text-om-mahogany text-base md:text-lg" style={{ fontFamily: "'EB Garamond', serif" }}>{a}</p>
              </div>
            ))}
          </div>
        </div>
