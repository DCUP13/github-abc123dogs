        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ol className="mt-2 ml-4 text-sm text-blue-700 dark:text-blue-400 list-decimal space-y-1">
              <li>Visit <a href="https://rapidapi.com/apimaker/api/us-housing-market-data1" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-600 dark:hover:text-blue-300">US Housing Market Data on RapidAPI</a></li>
