          ...
          >
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1 min-w-0">
                {state.title && (
                  <h3 id="confirm-dialog-title" className="text-base font-semibold text-gray-900 dark:text-white mb-1">{state.title}</h3>
                )}
                <p id="confirm-dialog-desc" className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">{state.message}</p>
              </div>
            </div>
