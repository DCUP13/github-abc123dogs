...
import { Mail, Sparkles, Gift, TrendingUp, Zap, Users, CheckCircle, Rocket, Star, Bell, Award, Clock, Shield , Menu, X} from 'lucide-react';
...
export function UpdatesPage({ onBackClick, onSignInClick }: UpdatesPageProps) {
    ...
    <div className="min-h-screen bg-om-cream font-body">
      ...
      <section className="pt-36 pb-14 px-4 sm:px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-om-gold text-sm md:text-base font-medium tracking-widest uppercase mb-4">Always Improving</p>
      ...
      <section className="py-14 px-4 sm:px-6 bg-om-forest-deep">
        <div className="max-w-4xl mx-auto">
          <div className="border border-om-forest rounded-xl p-10 text-center">
            ...
            <p className="text-om-tan text-lg md:text-xl mb-7" style={{ fontFamily: "'EB Garamond', serif" }}>
              No upgrade fees. No hidden costs. No surprises. Every feature we release is automatically available to you.
            </p>
            <div className="flex flex-wrap justify-center gap-6 text-om-tan text-base md:text-lg">
      ...
      <section className="py-16 px-4 sm:px-6 bg-om-cream">
        <div className="max-w-7xl mx-auto">
          <div className="mb-10">
            ...
            <h2 className="text-2xl md:text-4xl font-display font-semibold text-om-forest-deep mb-2">What You Get with Every Update</h2>
      ...
      <section className="py-16 px-4 sm:px-6 bg-om-parchment">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-2xl md:text-4xl font-display font-semibold text-om-forest-deep mb-3">Our Update Philosophy</h2>
      ...
      <section className="py-16 px-4 sm:px-6 bg-om-cream">
        <div className="max-w-7xl mx-auto">
          <div className="mb-12 text-center">
            ...
            <h2 className="text-2xl md:text-4xl font-display font-semibold text-om-forest-deep mb-3">What's Coming Next</h2>
      ...
      <section className="py-20 px-4 sm:px-6 bg-om-forest">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button onClick={() => window.location.href = 'mailto:sales@loireply.com?subject=Product Updates Inquiry'} className="px-10 py-3.5 bg-om-gold text-om-forest-deep hover:bg-om-gold-dark font-medium transition-colors rounded">
              Learn More
            </button>
          </div>
        </div>
